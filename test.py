...
# Assuming the data is already loaded into DataFrames
                ...
                html.Div([
                    ...
                    dcc.Dropdown(
                        ...
                        options=[{'label': name, 'value': name} 
                                for name in fighters_df['Name'].unique()],
        ...
        dcc.Tab(label='Match Analysis', children=[
            html.Div([
                html.Div([
                    ...
                    dcc.Dropdown(
                        id='match-dropdown',
                        options=[{'label': bout, 'value': bout} 
                                for bout in results_df['BOUT'].unique()],
...
def update_style_breakdown(selected_fighter):
    ...
    fig.update_layout(
        title_text=f"{selected_fighter}'s fighting analysis",
        height=500
    )
